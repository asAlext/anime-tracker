...
      ligne.innerHTML =  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea class="info-titre" placeholder="Titre libre..." style="border:none; font-weight:bold;">${item.texte || ''}</textarea> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="delete-x">×</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;;
    } else if (item.type === 'entree') {
      ligne.className = 'info-ligne entree-ligne';
      ligne.style.marginBottom = '25px';
      ligne.innerHTML =  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="info-nom" value="${item.nom || ''}" placeholder="Nom" style="margin-right:35px; border:none;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select class="info-type" style="margin-right:35px; border:none;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="Anime" ${item.typeVal === 'Anime' ? 'selected' : ''}>Anime</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="Film" ${item.typeVal === 'Film' ? 'selected' : ''}>Film</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="OVA" ${item.typeVal === 'OVA' ? 'selected' : ''}>OVA</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</select> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select class="info-statut" style="border:none;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="Terminé" ${item.statut === 'Terminé' ? 'selected' : ''}>Terminé</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="En Cours" ${item.statut === 'En Cours' ? 'selected' : ''}>En Cours</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="En Pause" ${item.statut === 'En Pause' ? 'selected' : ''}>En Pause</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="A Regarder" ${item.statut === 'A Regarder' ? 'selected' : ''}>A Regarder</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</select> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="delete-x">×</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;;
...
  ligne.className = 'info-ligne entree-ligne';
  ligne.style.marginBottom = '25px';
  ligne.innerHTML =  &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="info-nom" placeholder="Nom" style="margin-right:35px; border:none;"> &nbsp;&nbsp;&nbsp;&nbsp;<select class="info-type" style="margin-right:35px; border:none;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="Anime">Anime</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="Film">Film</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="OVA">OVA</option> &nbsp;&nbsp;&nbsp;&nbsp;</select> &nbsp;&nbsp;&nbsp;&nbsp;<select class="info-statut" style="border:none;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="Terminé">Terminé</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="En Cours">En Cours</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="En Pause">En Pause</option> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<option value="A Regarder">A Regarder</option> &nbsp;&nbsp;&nbsp;&nbsp;</select> &nbsp;&nbsp;&nbsp;&nbsp;<span class="delete-x">×</span> &nbsp;&nbsp;;
  
  container.appendChild(ligne);

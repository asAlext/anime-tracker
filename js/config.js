// config.js – Configuration Supabase (sans redéclaration)
...
// Utilise la variable globale 'supabase' définie par le CDN
const client = supabase.createClient(SUPABASE_URL, SUPABASE_ANON_KEY);

// Rend le client accessible globalement
window.supabaseClient = client;

console.log("Supabase chargé depuis config.js : OK");
